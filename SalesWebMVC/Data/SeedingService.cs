...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            // Se existir algum dado nessas entidades, sai fora
            ...
            Seller s1 = new Seller(1, "Toni", "toni@gmail.com", new DateTime(1992, 4, 21), 1000.00, d1);
